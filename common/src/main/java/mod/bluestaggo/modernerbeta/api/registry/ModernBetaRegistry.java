...
public final class ModernBetaRegistry<T> {
    ...
    public Optional<T> getOrEmpty(String key) {
        if (!this.contains(key)) {
            ModernerBeta.log(Level.WARN, "Registry " + this.name + " does not contain entry named " + key);
        }
    ...
    public T getOrDefault(String key) {
        if (!this.contains(key)) {
            ModernerBeta.log(Level.WARN, "Registry " + this.name + " does not contain entry named " + key + ", getting default entry.");

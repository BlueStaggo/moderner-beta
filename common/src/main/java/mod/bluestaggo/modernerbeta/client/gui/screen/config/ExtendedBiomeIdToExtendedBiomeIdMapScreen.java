...
public class ExtendedBiomeIdToExtendedBiomeIdMapScreen extends ModernBetaGraphicalMapSettingsScreen {
    public ExtendedBiomeIdToExtendedBiomeIdMapScreen(String title, Screen parent, GeneratorOptionsHolder generatorOptionsHolder, NbtCompound settings, Consumer<NbtCompound> onDone) {
    ...
    protected List<SimpleOption<?>> getOptions(int i) {
        ...
        options.addAll(this.extendedBiomeIdOption(VALUE + i));
        return options;
    }

...
public record LayerType<L extends Layer>(MapCodec<L> codec) {
    ...
    public static final LayerType<ConditionalOverlayLayer> CONDITIONAL_MASK = register("conditional_mask", ConditionalOverlayLayer.CODEC);
    ...
    public static final LayerType<InitMutationLayer> INIT_MUTATION = register("init_mutation", InitMutationLayer.CODEC);
    ...
    public static final LayerType<PreSkipRandomLayer> PRE_SKIP_RANDOM = register("pre_skip_random", PreSkipRandomLayer.CODEC);
    ...
    public static final LayerType<WeightedLayerLayer> WEIGHTED_LAYER = register("weighted_layer", WeightedLayerLayer.CODEC);

...
public record LayerType<L extends Layer>(MapCodec<L> codec) {
    ...
    public static final LayerType<SupplyRandomLayer> SUPPLY_RANDOM = register("supply_random", SupplyRandomLayer.CODEC);
    public static final LayerType<UnsaltedLayer> UNSALTED = register("unsalted", UnsaltedLayer.CODEC);

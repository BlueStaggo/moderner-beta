...
public record BiomePredicateType<F extends BiomePredicate>(MapCodec<F> codec) {
    ...
    public static final BiomePredicateType<WrappedIntMatchBiomePredicate> MUTATION = register("mutation", WrappedIntMatchBiomePredicate.CODEC);
    ...
    public static final BiomePredicateType<UniqueNeighborBiomePredicate> UNIQUE_NEIGHBOR = register("unique_neighbor", UniqueNeighborBiomePredicate.CODEC);
    ...
    public static final BiomePredicateType<TrueBiomePredicate> TRUE = register("true", TrueBiomePredicate.CODEC);
    public static final BiomePredicateType<WrappedIntMatchBiomePredicate> WRAPPED_INT_MATCH = register("wrapped_int_match", WrappedIntMatchBiomePredicate.CODEC);

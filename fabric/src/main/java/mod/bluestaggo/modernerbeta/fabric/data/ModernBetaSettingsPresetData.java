...
import static mod.bluestaggo.modernerbeta.settings.ModernBetaSettingsPresets.*;
import static mod.bluestaggo.modernerbeta.settings.SettingsComponentTypes.*;

public final class ModernBetaSettingsPresetData {
    ...
    public static void bootstrap(BootstrapContext<ModernBetaSettingsPreset> context) {
        Identifier betaId = BETA_1_7_3.identifier();
        Identifier majorId = RELEASE_1_12_2.identifier();

...
public class ModernBetaTagProviderBiome extends FabricTagProvider<Biome> {
    ...
    private void configureModernBeta(WrapperLookup lookup) {
        ...
        this.getOrCreateTagBuilder(IS_MODERN_BETA).add(
        ...
        this.getOrCreateTagBuilder(IS_EARLY_RELEASE).add(
            ModernBetaBiomes.EARLY_RELEASE_ICE_PLAINS,
            ModernBetaBiomes.EARLY_RELEASE_SWAMPLAND,
            ModernBetaBiomes.EARLY_RELEASE_EXTREME_HILLS,
            ModernBetaBiomes.EARLY_RELEASE_TAIGA
        ...
        this.getOrCreateTagBuilder(IS_LATE_BETA).add(
            ModernBetaBiomes.LATE_BETA_EXTREME_HILLS,
            ModernBetaBiomes.LATE_BETA_SWAMPLAND,
            ModernBetaBiomes.LATE_BETA_PLAINS,
            ModernBetaBiomes.LATE_BETA_TAIGA
        ...
        this.getOrCreateTagBuilder(IS_BETA).add(
            ModernBetaBiomes.BETA_FOREST,
            ModernBetaBiomes.BETA_SHRUBLAND,
            ModernBetaBiomes.BETA_DESERT,
            ModernBetaBiomes.BETA_SAVANNA,
        ...
        this.getOrCreateTagBuilder(IS_PE).add(
            ModernBetaBiomes.PE_FOREST,
            ModernBetaBiomes.PE_SHRUBLAND,
            ModernBetaBiomes.PE_DESERT,
            ModernBetaBiomes.PE_SAVANNA,
        ...
        this.getOrCreateTagBuilder(IS_ALPHA).add(
            ModernBetaBiomes.ALPHA,
            ModernBetaBiomes.ALPHA_WINTER
        );

        this.getOrCreateTagBuilder(IS_INFDEV).add(
            ModernBetaBiomes.INFDEV_611,
            ModernBetaBiomes.INFDEV_420,
            ModernBetaBiomes.INFDEV_415,
            ModernBetaBiomes.INFDEV_325,
        ...
        this.getOrCreateTagBuilder(IS_INDEV).add(
            ModernBetaBiomes.INDEV_NORMAL,
            ModernBetaBiomes.INDEV_HELL,
            ModernBetaBiomes.INDEV_PARADISE,
            ModernBetaBiomes.INDEV_WOODS
        ...
        this.getOrCreateTagBuilder(IS_FOREST).add(
            ModernBetaBiomes.BETA_FOREST,
            ModernBetaBiomes.PE_FOREST
        );
        
        this.getOrCreateTagBuilder(IS_SEASONAL_FOREST).add(
            ModernBetaBiomes.BETA_SEASONAL_FOREST,
            ModernBetaBiomes.PE_SEASONAL_FOREST
        );
        
        this.getOrCreateTagBuilder(IS_RAINFOREST).add(
            ModernBetaBiomes.BETA_RAINFOREST,
            ModernBetaBiomes.PE_RAINFOREST
        );

        this.getOrCreateTagBuilder(IS_DESERT).add(
            ModernBetaBiomes.BETA_DESERT,
            ModernBetaBiomes.PE_DESERT
        );
        
        this.getOrCreateTagBuilder(IS_PLAINS).add(
            ModernBetaBiomes.BETA_PLAINS,
            ModernBetaBiomes.PE_PLAINS,
            ModernBetaBiomes.LATE_BETA_PLAINS
        );
        
        this.getOrCreateTagBuilder(IS_SHRUBLAND).add(
            ModernBetaBiomes.BETA_SHRUBLAND,
            ModernBetaBiomes.PE_SHRUBLAND
        );
        
        this.getOrCreateTagBuilder(IS_SAVANNA).add(
            ModernBetaBiomes.BETA_SAVANNA,
            ModernBetaBiomes.PE_SAVANNA
        );
        
        this.getOrCreateTagBuilder(IS_SWAMP).add(
            ModernBetaBiomes.BETA_SWAMPLAND,
            ModernBetaBiomes.PE_SWAMPLAND,
            ModernBetaBiomes.LATE_BETA_SWAMPLAND,
            ModernBetaBiomes.EARLY_RELEASE_SWAMPLAND
        ...
        this.getOrCreateTagBuilder(IS_TAIGA).add(
            ModernBetaBiomes.BETA_TAIGA,
            ModernBetaBiomes.PE_TAIGA,
            ModernBetaBiomes.LATE_BETA_TAIGA,
            ModernBetaBiomes.EARLY_RELEASE_TAIGA
        ...
        this.getOrCreateTagBuilder(IS_TUNDRA).add(
            ModernBetaBiomes.BETA_TUNDRA,
            ModernBetaBiomes.PE_TUNDRA,
            ModernBetaBiomes.BETA_ICE_DESERT,
            ModernBetaBiomes.PE_ICE_DESERT,
        ...
        this.getOrCreateTagBuilder(IS_OCEAN).add(
            ModernBetaBiomes.BETA_OCEAN,
            ModernBetaBiomes.BETA_LUKEWARM_OCEAN,
            ModernBetaBiomes.BETA_WARM_OCEAN,
            ModernBetaBiomes.BETA_COLD_OCEAN,
        ...
        this.getOrCreateTagBuilder(SURFACE_CONFIG_SAND)
        ...
        this.getOrCreateTagBuilder(SURFACE_CONFIG_RED_SAND);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_BADLANDS)
        ...
        this.getOrCreateTagBuilder(SURFACE_CONFIG_NETHER)
            .addOptionalTag(SURFACE_CONFIG_IS_NETHER)
            .add(BiomeKeys.NETHER_WASTES);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_WARPED_NYLIUM)
            .add(BiomeKeys.WARPED_FOREST);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_CRIMSON_NYLIUM)
            .add(BiomeKeys.CRIMSON_FOREST);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_BASALT)
            .add(BiomeKeys.BASALT_DELTAS);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_SOUL_SOIL)
            .add(BiomeKeys.SOUL_SAND_VALLEY);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_END)
        ...
        this.getOrCreateTagBuilder(SURFACE_CONFIG_GRASS)
            .addOptionalTag(SURFACE_CONFIG_SWAMP)
            .add(BiomeKeys.SWAMP);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_MUD)
            .add(BiomeKeys.MANGROVE_SWAMP);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_MYCELIUM)
            .add(BiomeKeys.MUSHROOM_FIELDS);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_PODZOL)
            .add(
                BiomeKeys.OLD_GROWTH_PINE_TAIGA,
                BiomeKeys.OLD_GROWTH_SPRUCE_TAIGA
            );
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_STONE)
            .add(
                BiomeKeys.STONY_PEAKS,
                BiomeKeys.STONY_SHORE
            );
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_SNOW)
            .add(BiomeKeys.SNOWY_SLOPES);
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_SNOW_DIRT)
            .add(
                BiomeKeys.GROVE,
                BiomeKeys.ICE_SPIKES
            );
        
        this.getOrCreateTagBuilder(SURFACE_CONFIG_SNOW_PACKED_ICE)
            .add(BiomeKeys.FROZEN_PEAKS);

        this.getOrCreateTagBuilder(SURFACE_CONFIG_SNOW_STONE)
            .add(BiomeKeys.JAGGED_PEAKS);

        /* Modern Beta Biome Height Tags */

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_DEFAULT)
            .addTag(IS_TUNDRA)
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_OCEAN)
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_DESERT)
            .addTag(IS_DESERT)
            .add(
                BiomeKeys.DESERT,
                BiomeKeys.BADLANDS,
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_BETA_HILLS)
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_EXTREME_HILLS)
            .add(
                ModernBetaBiomes.EARLY_RELEASE_EXTREME_HILLS,
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_TAIGA)
            .addTag(BiomeTags.IS_TAIGA);

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_SWAMPLAND)
            .addTag(IS_SWAMP)
            .add(
                BiomeKeys.SWAMP,
                BiomeKeys.MANGROVE_SWAMP
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_RIVER)
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_MOUNTAINS)
            .addTag(IS_TUNDRA)
            .add(
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_MUSHROOM_ISLAND)
            .add(BiomeKeys.MUSHROOM_FIELDS);

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_MUSHROOM_ISLAND_SHORE)
            .add(BiomeKeys.MUSHROOM_FIELDS);

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_BEACH)
            .add(
                BiomeKeys.BEACH,
                BiomeKeys.SNOWY_BEACH
            );

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_HILLS)
            .addTag(HEIGHT_CONFIG_DESERT)
            .addTag(HEIGHT_CONFIG_TAIGA);

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_SHORT_HILLS)
            .addTag(IS_FOREST)
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_EXTREME_HILLS_EDGE)
            .addTag(HEIGHT_CONFIG_EXTREME_HILLS);

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_JUNGLE)
            .add(
                BiomeKeys.JUNGLE,
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_JUNGLE_HILLS)
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_PLATEAU)
            .add(
                BiomeKeys.CHERRY_GROVE,
                BiomeKeys.MEADOW
            );

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_SWAMPLAND_HILLS)
            .addTag(HEIGHT_CONFIG_SWAMPLAND);

        this.getOrCreateTagBuilder(HEIGHT_CONFIG_PLATEAU_HILL)
            .add(
                BiomeKeys.BADLANDS,
                BiomeKeys.ERODED_BADLANDS,
                BiomeKeys.WOODED_BADLANDS
        ...
        this.getOrCreateTagBuilder(HEIGHT_CONFIG_DEEP_OCEAN)
            .add(
    ...
    private void configureVanilla(WrapperLookup lookup) {
        ...
        this.getOrCreateTagBuilder(BiomeTags.BURIED_TREASURE_HAS_STRUCTURE)
            .addTag(BiomeTags.IS_OCEAN);
        
        this.getOrCreateTagBuilder(BiomeTags.DESERT_PYRAMID_HAS_STRUCTURE)
            .addTag(IS_DESERT);
        
        this.getOrCreateTagBuilder(BiomeTags.IGLOO_HAS_STRUCTURE)
            .addTag(IS_TUNDRA);
        
        this.getOrCreateTagBuilder(BiomeTags.JUNGLE_TEMPLE_HAS_STRUCTURE)
            .addTag(IS_RAINFOREST);
        ...
        this.getOrCreateTagBuilder(BiomeTags.OCEAN_RUIN_COLD_HAS_STRUCTURE).add(
            ModernBetaBiomes.BETA_OCEAN,
            ModernBetaBiomes.BETA_COLD_OCEAN,
            ModernBetaBiomes.BETA_FROZEN_OCEAN,
        ...
        this.getOrCreateTagBuilder(BiomeTags.OCEAN_RUIN_WARM_HAS_STRUCTURE).add(
            ModernBetaBiomes.BETA_LUKEWARM_OCEAN,
            ModernBetaBiomes.BETA_WARM_OCEAN,
        ...
        this.getOrCreateTagBuilder(BiomeTags.VILLAGE_SNOWY_HAS_STRUCTURE)
            .addTag(IS_TUNDRA);
        
        this.getOrCreateTagBuilder(BiomeTags.VILLAGE_TAIGA_HAS_STRUCTURE)
            .addTag(IS_TAIGA);
        
        this.getOrCreateTagBuilder(BiomeTags.WOODLAND_MANSION_HAS_STRUCTURE)
            .addTag(IS_SEASONAL_FOREST);
        
        /* Misc. Tags */
        
        this.getOrCreateTagBuilder(BiomeTags.PRODUCES_CORALS_FROM_BONEMEAL).add(
            ModernBetaBiomes.BETA_WARM_OCEAN,
            ModernBetaBiomes.PE_WARM_OCEAN
        );
        
        this.getOrCreateTagBuilder(BiomeTags.POLAR_BEARS_SPAWN_ON_ALTERNATE_BLOCKS).add(
            ModernBetaBiomes.BETA_FROZEN_OCEAN,
            ModernBetaBiomes.PE_FROZEN_OCEAN
        );

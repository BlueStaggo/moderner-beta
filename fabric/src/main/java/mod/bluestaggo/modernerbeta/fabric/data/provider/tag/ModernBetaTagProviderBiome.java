...
public class ModernBetaTagProviderBiome extends FabricTagProvider<Biome> {
    ...
    private void configureConventional(Provider provider) {
        ...
        this.builder(ConventionalBiomeTags.IS_AQUATIC_ICY)
            .add(
                ModernBetaBiomes.BETA_FROZEN_OCEAN,
                ModernBetaBiomes.PE_FROZEN_OCEAN
            );
        
        this.builder(ConventionalBiomeTags.IS_COLD)
            .addTag(IS_TAIGA)
            .addTag(IS_TUNDRA);
        
        this.builder(ConventionalBiomeTags.IS_DRY)
            .addTag(IS_DESERT)
            .addTag(IS_PLAINS)
            .addTag(IS_SAVANNA)
            .addTag(IS_SHRUBLAND)
        ...
        this.builder(ConventionalBiomeTags.IS_HOT)
            .addTag(IS_DESERT)
            .addTag(IS_PLAINS)
            .addTag(IS_SEASONAL_FOREST)
            .addTag(IS_RAINFOREST);
        
        this.builder(ConventionalBiomeTags.IS_TEMPERATE)
            .addTag(IS_SAVANNA)
            .addTag(IS_SHRUBLAND)
            .addTag(IS_FOREST)
            .addTag(IS_SWAMP);
        
        this.builder(ConventionalBiomeTags.IS_WET)
            .addTag(IS_OCEAN)
            .addTag(IS_SWAMP)
            .addTag(IS_RAINFOREST);
        ...
        this.builder(ConventionalBiomeTags.IS_OVERWORLD)
            .addTag(IS_MODERN_BETA);

        this.builder(ConventionalBiomeTags.IS_JUNGLE)
            .addTag(IS_RAINFOREST);
        
        this.builder(ConventionalBiomeTags.IS_DEEP_OCEAN)
            .addTag(IS_OCEAN);
        ...
        this.builder(ConventionalBiomeTags.IS_SHALLOW_OCEAN)
            .addTag(IS_OCEAN);
        ...
        this.builder(ConventionalBiomeTags.IS_SNOWY_PLAINS)
            .addTag(IS_TUNDRA);
        
        this.builder(ConventionalBiomeTags.IS_SWAMP)
            .addTag(IS_SWAMP);
        
        this.builder(ConventionalBiomeTags.IS_TAIGA)
            .addTag(IS_TAIGA);
        ...
        this.builder(ConventionalBiomeTags.IS_VEGETATION_DENSE)
            .addTag(IS_RAINFOREST)
            .addTag(IS_PLAINS);
        
        this.builder(ConventionalBiomeTags.IS_VEGETATION_SPARSE)
            .addTag(IS_DESERT)
            .addTag(IS_SAVANNA)
            .addTag(IS_SHRUBLAND)
            .addTag(IS_TUNDRA)
    ...
    private void configureModded(Provider provider) {
        ...
        *///? }
        ...
        this.builder(TagKey.create(registryKey, VersionCompat.id("sereneseasons", "blacklisted_biomes")))
            .addTag(IS_INDEV)
            .addTag(IS_INFDEV)
            .addTag(IS_ALPHA);

        this.builder(TagKey.create(registryKey, VersionCompat.id("sereneseasons", "lesser_color_change_biomes")))
            .add(ModernBetaBiomes.EARLY_RELEASE_SWAMPLAND);

        this.builder(TagKey.create(registryKey, VersionCompat.id("sereneseasons", "tropical_biomes")))
            .addTag(IS_RAINFOREST)
            .addTag(IS_DESERT)
            .addTag(IS_SAVANNA)
            .addTag(IS_SWAMP)

...
public class ModernBetaTagProviderBiomeSource extends FabricTagsProvider<com.mojang.serialization.MapCodec<? extends BiomeSource>> {
    public ModernBetaTagProviderBiomeSource(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registryLookupFuture) {

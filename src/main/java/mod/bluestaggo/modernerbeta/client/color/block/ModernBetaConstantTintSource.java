...
public class ModernBetaConstantTintSource implements net.minecraft.client.color.block.BlockColor {
    private final BlockColorSampler colorSampler;
    private final int constantTint;
    private final int worldConstantTint;
    private final net.minecraft.client.color.block.BlockColor elseIf;

    public ModernBetaConstantTintSource(
        BlockColorSampler sampler,
        int constant,
        net.minecraft.client.color.block.BlockColor elseIf
    ) {

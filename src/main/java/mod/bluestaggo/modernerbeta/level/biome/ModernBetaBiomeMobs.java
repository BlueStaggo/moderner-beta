...
public class ModernBetaBiomeMobs {
    ...
    public static void addSquid(MobSpawnSettings.Builder spawnSettings) {
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_CREATURE,
            net.minecraft.world.entity.EntityType.SQUID, 10, 1, 4);
    }
    ...
    public static void addTurtles(MobSpawnSettings.Builder spawnSettings) {
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.TURTLE, 5, 2, 5);
    }
    
    public static void addWolves(MobSpawnSettings.Builder spawnSettings) {
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.WOLF, 5, 4, 4);
    }
    ...
    public static void addColdOceanMobs(MobSpawnSettings.Builder spawnSettings) {
        ...
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_AMBIENT,
            net.minecraft.world.entity.EntityType.SALMON, 15, 1, 5);
    }
    
    public static void addFrozenOceanMobs(MobSpawnSettings.Builder spawnSettings) {
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_CREATURE,
            net.minecraft.world.entity.EntityType.SQUID, 1, 1, 4);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_AMBIENT,
            net.minecraft.world.entity.EntityType.SALMON, 15, 1, 5);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.POLAR_BEAR, 1, 1, 2);

        BiomeDefaultFeatures.commonSpawns(spawnSettings);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.MONSTER,
            net.minecraft.world.entity.EntityType.DROWNED, 5, 1, 1);
    }
    ...
    public static void addOceanMobs(MobSpawnSettings.Builder spawnSettings) {
        ...
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_CREATURE,
            net.minecraft.world.entity.EntityType.DOLPHIN, 1, 1, 2);
    }
    ...
    public static void addWarmOceanMobs(MobSpawnSettings.Builder spawnSettings) {
        ...
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_AMBIENT,
            net.minecraft.world.entity.EntityType.PUFFERFISH, 15, 1, 3);
    }
    ...
    public static void addLukewarmOceanMobs(MobSpawnSettings.Builder spawnSettings) {
        ...
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_AMBIENT,
            net.minecraft.world.entity.EntityType.PUFFERFISH, 5, 1, 3);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_AMBIENT,
            net.minecraft.world.entity.EntityType.TROPICAL_FISH, 25, 8, 8);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.WATER_CREATURE,
            net.minecraft.world.entity.EntityType.DOLPHIN, 2, 1, 2);
    }
    ...
    public static void addRainforestMobs(MobSpawnSettings.Builder spawnSettings) {
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.MONSTER,
            net.minecraft.world.entity.EntityType.OCELOT, 2, 1, 3);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.PANDA, 2, 1, 2);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.PARROT, 40, 1, 2);
    }
    
    public static void addSwamplandMobs(MobSpawnSettings.Builder spawnSettings) {
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.MONSTER,
            net.minecraft.world.entity.EntityType.SLIME, 1, 1, 1);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.FROG, 10, 2, 5);
    }
    ...
    public static void addTaigaMobs(MobSpawnSettings.Builder spawnSettings) {
        ...
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.LLAMA, 4, 4, 6);
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
    ...
    public static void addTundraMobs(MobSpawnSettings.Builder spawnSettings) {
        ...
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.GOAT, 5, 4, 6);
    }
    ...
    public static void addSkyMobs(MobSpawnSettings.Builder spawnSettings) {
        ...
        VersionCompat.addSpawnEntry(spawnSettings, MobCategory.CREATURE,
            net.minecraft.world.entity.EntityType.CHICKEN, 10, 4, 4);
    }
}

...
public class MappedNoiseLayer extends Layer {
    ...
    private final ExtendedHolder<Biome> middleBiome;
    ...
    public record Entry(double value, ExtendedHolder<Biome> biome) {
        public static final Codec<Entry> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                Codec.DOUBLE.fieldOf("value").forGetter(Entry::value),
                ExtendedBiomeIds.CODEC.fieldOf("biome").forGetter(Entry::biome)

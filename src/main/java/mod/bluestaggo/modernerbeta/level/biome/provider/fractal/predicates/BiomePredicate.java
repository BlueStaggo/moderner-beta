...
public interface BiomePredicate {
    ...
    static BiomePredicate diagonalNeighborsMatch(ExtendedHolder<Biome> biome, int neighborCount) {
        return diagonalNeighborsMatch(of(biome), neighborCount);
    }

    static BiomePredicate diagonalNeighborsMatch(List<Set<ExtendedHolder<Biome>>> categories, int neighborCount) {
    ...
    @SafeVarargs
    static BiomePredicate inSet(ExtendedHolder<Biome>... biomes) {
        return new InSetBiomePredicate(Set.of(biomes));
    }

    static BiomePredicate inSet(Set<ExtendedHolder<Biome>> biomes) {
    ...
    static BiomePredicate neighborsMatch(ExtendedHolder<Biome> biome, int neighborCount) {
        return neighborsMatch(of(biome), neighborCount);
    }

    static BiomePredicate neighborsMatch(List<Set<ExtendedHolder<Biome>>> categories, int neighborCount) {
    ...
    @SafeVarargs
    static BiomePredicate noneInSet(ExtendedHolder<Biome>... biomes) {
        return inSet(biomes).invert();
    }

    static BiomePredicate noneInSet(Set<ExtendedHolder<Biome>> biomes) {
        return inSet(biomes).invert();
    }

    static BiomePredicate of(ExtendedHolder<Biome> biome) {
    ...
    static BiomePredicate simpleHills(Set<ExtendedHolder<Biome>> affectedBiomes) {

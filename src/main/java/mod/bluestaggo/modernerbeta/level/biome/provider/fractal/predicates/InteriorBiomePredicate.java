...
public record InteriorBiomePredicate(Type type) implements BiomePredicate {
    ...
    public enum Type implements StringRepresentable {
        ...
        public boolean matches(ExtendedHolder<Biome> biome, Layer layer, int x, int z) {
            ExtendedHolder<Biome>[] neighbors = this.diagonal ? layer.sampleDiagonalNeighbors(x, z) : layer.sampleNeighbors(x, z);

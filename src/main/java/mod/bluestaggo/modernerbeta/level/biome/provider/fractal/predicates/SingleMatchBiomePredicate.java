...
public record SingleMatchBiomePredicate(ExtendedHolder<Biome> biome) implements BiomePredicate {
    public static final com.mojang.serialization.MapCodec<SingleMatchBiomePredicate> CODEC = VersionCompat.createMaybeMapCodec(
        instance -> instance.group(
            ExtendedBiomeIds.CODEC.fieldOf("biome").forGetter(predicate -> predicate.biome)

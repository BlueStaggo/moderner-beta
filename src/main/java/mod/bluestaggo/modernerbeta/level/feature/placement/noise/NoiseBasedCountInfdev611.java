...
public class NoiseBasedCountInfdev611 implements NoiseBasedCount {
    ...
    public NoiseBasedCountInfdev611(RandomSource random) {
        this.noiseSampler = new PerlinOctaveNoise(new LegacyRandomSource(random.nextLong()), 8, PerlinNoiseSettings.ALPHA);
    }
    
    public NoiseBasedCountInfdev611(OctaveNoise noiseSampler) {

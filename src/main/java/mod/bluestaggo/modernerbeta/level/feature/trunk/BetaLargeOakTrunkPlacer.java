...
public class BetaLargeOakTrunkPlacer extends TrunkPlacer {
    ...
    private int makeOrCheckBranch(WorldGenLevel level, BiConsumer<BlockPos, BlockState> replacer, RandomSource random, BlockPos startPos, BlockPos branchPos, boolean make, TreeConfiguration config) {

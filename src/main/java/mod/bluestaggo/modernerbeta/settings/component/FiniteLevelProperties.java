...
public record FiniteLevelProperties(
    ...
    public static final Codec<FiniteLevelProperties> CODEC = RecordCodecBuilder.create(
        instance -> instance.group(
            StringRepresentable.fromEnum(IndevType::values).fieldOf("type").orElse(IndevType.ISLAND).forGetter(FiniteLevelProperties::type),
            StringRepresentable.fromEnum(IndevTheme::values).fieldOf("theme").orElse(IndevTheme.NORMAL).forGetter(FiniteLevelProperties::theme),

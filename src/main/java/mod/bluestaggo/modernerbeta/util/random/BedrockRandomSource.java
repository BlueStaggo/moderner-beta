 ...
 */
public class BedrockRandomSource extends LegacyRandomSource {
    ...
    public BedrockRandomSource(long seed) {
        super(0);
    ...
    public RandomSource fork() {
        return new BedrockRandomSource(this.nextInt());
    }

    @Override
    public PositionalRandomFactory forkPositional() {
        return new BedrockPositionalRandomFactory(this.nextInt());
    }
    ...
    public static class BedrockPositionalRandomFactory implements PositionalRandomFactory {
        private final int seed;

        public BedrockPositionalRandomFactory(int seed) {
            this.seed = seed;
        }
        ...
        public RandomSource at(int x, int y, int z) {
            ...
            return new BedrockRandomSource((int) seed);
        }

        @Override
        public RandomSource fromHashOf(String seed) {
            int i = seed.hashCode();
            return new BedrockRandomSource(i ^ this.seed);
        }
        ...
        public void parityConfigString(StringBuilder info) {
            info.append("BedrockPositionalRandomFactory{").append(this.seed).append("}");
        }
    }
}
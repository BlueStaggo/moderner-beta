...
public record BiomePredicateType<P extends BiomePredicate>(com.mojang.serialization./*Map*/Codec<P> codec) {
    ...
    private static <P extends BiomePredicate> BiomePredicateType<P> register(String id, com.mojang.serialization./*Map*/Codec<P> codec) {
